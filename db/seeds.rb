puts "Seeding of the database tables..."
    ...
    status = ["Pending", "Completed", "Cancelled"]
        ...
        Task.create!(name:"Do laundry", description:"One week laundry", status: status.sample)

        Task.create!(name:"Wash dishes", description:"One day dishes",status: status.sample)
